...
class BurcDetailController: UIViewController {
    ...
    func configureUI(){
        ...
        beyazView.anchor(top: burcIconView.bottomAnchor, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingTop: 65,paddingLeft: 10, paddingBottom: 20,  paddingRight: 10)
        
        beyazView.addSubview(gezegenLabel)
        gezegenLabel.anchor(top: beyazView.topAnchor, left: beyazView.leftAnchor, paddingTop: 5, paddingLeft: 0)
        
        beyazView.addSubview(gezegenAdiLabel)
        gezegenAdiLabel.anchor(top: gezegenLabel.bottomAnchor, left: gezegenLabel.leftAnchor, right: gezegenLabel.rightAnchor, paddingTop: 5, paddingLeft: 25)
        
        beyazView.addSubview(elemetLabel)
        elemetLabel.anchor(top: beyazView.topAnchor, right: beyazView.rightAnchor, paddingTop: 5, paddingRight: 0)
        
        beyazView.addSubview(elementAdiLabel)
        elementAdiLabel.anchor(top: elemetLabel.bottomAnchor, left: elemetLabel.leftAnchor, right: elemetLabel.rightAnchor, paddingTop: 5, paddingRight: 0)
        ...
        yorumlarGunlukTextView.anchor(top: segmentControl.bottomAnchor, left: beyazView.leftAnchor,bottom: beyazView.bottomAnchor,  right: beyazView.rightAnchor, paddingTop: 10, paddingLeft: 10, paddingRight: 10)
        
        beyazView.addSubview(yorumlarHaftalikTextView)
        yorumlarHaftalikTextView.anchor(top: segmentControl.bottomAnchor, left: beyazView.leftAnchor,bottom: beyazView.bottomAnchor, right: beyazView.rightAnchor, paddingTop: 10, paddingLeft: 10, paddingRight: 10)
        
        beyazView.addSubview(yorumlarAylikTextView)
        yorumlarAylikTextView.anchor(top: segmentControl.bottomAnchor, left: beyazView.leftAnchor,bottom: beyazView.bottomAnchor,  right: beyazView.rightAnchor, paddingTop: 10, paddingLeft: 10, paddingRight: 10)
        
        beyazView.addSubview(yorumlarYillikTextView)
        yorumlarYillikTextView.anchor(top: segmentControl.bottomAnchor, left: beyazView.leftAnchor, bottom: beyazView.bottomAnchor, right: beyazView.rightAnchor, paddingTop: 10, paddingLeft: 10, paddingRight: 10)
        
        
        
        
        view.addSubview(burcImageViewBos)
        burcImageViewBos.centerX(inView: view, topAnchor: burcIconView.bottomAnchor, paddingTop: 10)
        view.addSubview(burcImageView)
        burcImageView.centerX(inView: view, topAnchor: burcIconView.bottomAnchor, paddingTop: 25)
